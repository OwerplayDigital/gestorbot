...
const ExtratoDemoRoute = ExtratoDemoRouteImport.update({
  id: '/extrato-demo',
  path: '/extrato-demo',
  getParentRoute: () => rootRouteImport,
} as any)
...
const ExtratoTokenRoute = ExtratoTokenRouteImport.update({
  id: '/extrato/$token',
  path: '/extrato/$token',
  getParentRoute: () => rootRouteImport,
} as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/extrato-demo': {
      id: '/extrato-demo'
      path: '/extrato-demo'
      fullPath: '/extrato-demo'
      preLoaderRoute: typeof ExtratoDemoRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/_authenticated/analises': {
    ...
    '/extrato/$token': {
      id: '/extrato/$token'
      path: '/extrato/$token'
      fullPath: '/extrato/$token'
      preLoaderRoute: typeof ExtratoTokenRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/pagar/$id': {
      id: '/pagar/$id'
...
const rootRouteChildren: RootRouteChildren = {
  ...
  ExtratoDemoRoute: ExtratoDemoRoute,
