...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({ meta: [{ charSet: "utf-8" }, { name: "viewport", content: "width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" }, { title: "GESTOR PRO - IPTV" }, { name: "description", content: "Sistema inteligente para revendedores de IPTV." }, { property: "og:site_name", content: "GESTOR PRO" }, { property: "og:title", content: "GESTOR PRO" }, { property: "og:description", content: "Controle sua operação IPTV mobile-first." }, { property: "og:image", content: "https://gestorbot.lovable.app/og-preview.png" }, { property: "og:type", content: "website" }, { name: "twitter:card", content: "summary_large_image" }], links: [{ rel: "stylesheet", href: appCss }, { rel: "icon", type: "image/png", href: "/favicon.png" }] }),
