...
const gestorLogo = "/gestor-logo.svg";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#020711" },
    ],
    links: [
