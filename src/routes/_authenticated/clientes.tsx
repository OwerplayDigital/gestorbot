...
import { Users, Search, ChevronLeft, ChevronRight, MessageCircle, Send, Pencil, ChevronDown, CalendarDays, RefreshCw, Minus, Plus, Smartphone, Copy, PlusCircle, Gift } from 'lucide-react';
