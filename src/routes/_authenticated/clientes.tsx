...
function ClientesPage() {
  ...
  const openApp = (client: Client) => { setSelectedClient(client); setAppForm({ id: '', app_nome: '', mac_address: '', app_key: '' }); setAppMode(client.devices?.length ? 'view' : 'new'); setIsAppOpen(true); };
