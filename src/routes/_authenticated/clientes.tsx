    ...
    <div className="p-4 md:p-8 space-y-6">
      ...
      <div className="relative">
        ...
        <Input 
          ...
          className="pl-10 rounded-xl bg-card border-muted/20"
          value={searchTerm}
          onChange={(e) => setSearchTerm(e.target.value)}
        />
      </div>

      <div className="bg-card border border-muted/20 rounded-2xl overflow-hidden">
        <Table>
          <TableHeader>
                  ...
                  <TableRow key={client.id} className="hover:bg-muted/50 border-muted/10 transition-colors">
                    ...
                    <TableCell className="text-right">
                      <div className="flex items-center justify-end gap-2">
                        <Button size="icon" variant="ghost" className="h-8 w-8 rounded-lg text-muted-foreground hover:text-white">
                          <Phone size={14} />
                        </Button>
                        <Button size="icon" variant="ghost" className="h-8 w-8 rounded-lg text-muted-foreground hover:text-white">
                          <Edit size={14} />
