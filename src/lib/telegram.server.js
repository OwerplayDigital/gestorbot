...
export const setUserStep = async (chatId, step) => {
...
export const getUserStep = async (chatId) => {
    const { data, error } = await supabaseAdmin
        .from("telegram_authorized_users")
        .select("current_step")
        .eq("telegram_chat_id", chatId)
...
export const createPlan = async (userId, name, price) => {
    const { data, error } = await supabaseAdmin
        .from("plans")
        .insert({
        user_id: userId,
...
export const createServer = async (userId, name, cost) => {
    const { data, error } = await supabaseAdmin
...
export const renewClient = async (clientId, newVencimento, userId) => {
...
export const resetFinancialHistory = async (clientId, userId) => {
...
export const resetGlobalFinancialHistory = async (userId) => {
